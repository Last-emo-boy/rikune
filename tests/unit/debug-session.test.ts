...
describe('debug tool definitions', () => {
  it('debug.session.start exports correctly', async () => {
    const mod = await import('../../src/tools/debug-session-start.js')
  ...
  it('debug.session.breakpoint exports correctly', async () => {
    const mod = await import('../../src/tools/debug-session-breakpoint.js')
  ...
  it('debug.session.continue exports correctly', async () => {
    const mod = await import('../../src/tools/debug-session-continue.js')
  ...
  it('debug.session.step exports correctly', async () => {
    const mod = await import('../../src/tools/debug-session-step.js')
  ...
  it('debug.session.inspect exports correctly', async () => {
    const mod = await import('../../src/tools/debug-session-inspect.js')
  ...
  it('debug.session.end exports correctly', async () => {
    const mod = await import('../../src/tools/debug-session-end.js')
