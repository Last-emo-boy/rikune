...
export const workflowSearchOutputSchema = z.object({
  ...
  data: z
    .object({
      ...
      search_profile: z.record(z.string(), z.any()),
      search_profiles: z.array(z.record(z.string(), z.any())).optional(),
      quota_decisions: z.array(z.record(z.string(), z.any())).optional(),
