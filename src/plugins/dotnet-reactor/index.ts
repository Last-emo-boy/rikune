...
import { antiTamperToolDefinition, createAntiTamperHandler } from './tools/anti-tamper.js'
import { stringDecryptToolDefinition, createStringDecryptHandler } from './tools/string-decrypt.js'
import {
  dynamicMethodsToolDefinition,
  createDynamicMethodsHandler,
} from './tools/dynamic-methods.js'
import {
  resourceExportToolDefinition,
  createResourceExportHandler,
...
const dotnetReactorPlugin: Plugin = {
  ...
  configSchema: [
    {
      envVar: 'REACTOR_SANDBOX_ENABLED',
      description: 'Allow sandbox execution for dynamic analysis (true/false)',
      required: false,
      defaultValue: 'false',
    },
  ],
  systemDeps: [
    {
      ...
      required: true,
      description: 'Python 3 for .NET Reactor analysis workers',
    },
    {
      type: 'python',
      name: 'dnfile',
      importName: 'dnfile',
      required: true,
      description: 'Python dnfile for .NET metadata analysis',
