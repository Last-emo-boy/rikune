...
import { fakeC2ToolDefinition, createFakeC2Handler } from './tools/fake-c2.js'
  ...
  configSchema: [
    {
      ...
      description: 'Default HTTPS listener port (1024–65535)',
      required: false,
      defaultValue: '8443',
    },
    {
      envVar: 'FAKE_C2_TLS_CERT',
      description: 'Path to custom TLS certificate (auto-generated if omitted)',
      required: false,
    },
