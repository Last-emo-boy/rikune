...
const angrPlugin: Plugin = {
  ...
  aspects: {
    formats: ['pe', 'elf', 'macho', 'shellcode'],
    platforms: ['windows', 'linux', 'macos'],
    architectures: ['x86', 'x64', 'arm', 'arm64'],
    execution: ['static', 'symbolic-execution', 'emulation'],
    safety: ['passive', 'no_live_sample_by_default'],
    capabilities: ['symbolic-execution', 'path-exploration', 'constraints', 'cfg', 'reachability'],
    evidence: ['functions', 'cfg', 'constraints', 'control-flow', 'provenance'],
  },
