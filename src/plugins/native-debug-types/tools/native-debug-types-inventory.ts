...
const NativeDebugTypesInventorySchema = z.object({
  ...
  debug_sections: z.record(z.any()),
  dwarf: z.record(z.any()),
  split_dwarf: z.record(z.any()),
  ctf: z.record(z.any()),
  source_profile: z.record(z.any()),
  type_graph_seeds: z.record(z.any()),
  risk_flags: z.array(z.record(z.any())),
  risk_summary: z.record(z.any()),
  symbol_server_plan: z.record(z.any()),
