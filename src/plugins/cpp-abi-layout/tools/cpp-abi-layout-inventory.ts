...
const CppAbiLayoutInventorySchema = z.object({
  ...
  abi_families: z.record(z.any()),
  evidence: z.array(z.record(z.any())),
  class_hints: z.array(z.record(z.any())),
  vtable_hints: z.array(z.record(z.any())),
  rtti_hints: z.array(z.record(z.any())),
  exception_profile: z.record(z.any()),
  layout_seeds: z.record(z.any()),
