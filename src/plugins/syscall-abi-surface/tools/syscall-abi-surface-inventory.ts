...
const SyscallAbiInventorySchema = z.object({
  ...
  instruction_evidence: z.array(z.record(z.string(), z.any())),
  string_evidence: z.array(z.record(z.string(), z.any())),
  syscall_stubs: z.array(z.record(z.string(), z.any())),
  windows_nt_surface: z.record(z.string(), z.any()),
  linux_syscall_surface: z.record(z.string(), z.any()),
  mach_trap_surface: z.record(z.string(), z.any()),
  anti_analysis_surface: z.record(z.string(), z.any()),
