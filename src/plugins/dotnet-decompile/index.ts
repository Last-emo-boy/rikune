...
import {
  dotnetDecompileToolDefinition,
  createDotnetDecompileHandler,
} from './tools/dotnet-decompile.js'
import {
  dotnetDecompileTypeToolDefinition,
  createDotnetDecompileTypeHandler,
} from './tools/dotnet-decompile-type.js'
...
const dotnetDecompilePlugin: Plugin = {
  ...
  aspects: {
    ...
    safety: ['passive'],
    capabilities: ['decompilation', 'types', 'resources', 'routing'],
    evidence: ['manifest', 'resources', 'provenance'],
  },
  ...
  configSchema: [
    {
      ...
      description: 'Path to ilspycmd binary',
      required: false,
      defaultValue: 'ilspycmd',
    },
  ],
  systemDeps: [
    {
      ...
      envVar: 'ILSPYCMD_PATH',
      dockerDefault: '/usr/local/bin/ilspycmd',
      versionFlag: '--version',
      required: false,
      ...
      buildArgs: { ILSPYCMD_VERSION: '9.1.0.7988' },
    },
  ],
