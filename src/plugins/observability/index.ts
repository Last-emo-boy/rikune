...
const plugin: Plugin = {
  ...
  aspects: {
    formats: ['mcp-session', 'analysis-run'],
    platforms: ['cross-platform'],
    execution: ['static', 'dynamic', 'observability'],
    safety: ['passive'],
    capabilities: ['metrics', 'tool-invocation-monitoring', 'latency-tracking', 'error-tracking'],
    evidence: ['metrics', 'timeline', 'provenance'],
  },
