...
const ghidraPlugin: Plugin = {
  ...
  configSchema: [
    ...
    {
      envVar: 'GHIDRA_PROJECT_DIR',
      description: 'Directory for Ghidra project files',
      required: false,
    },
  ],
  systemDeps: [
    {
      ...
      volumes: [
        {
          source: '${RIKUNE_DATA_ROOT:-D:/Docker/rikune}/ghidra-projects',
          target: '/ghidra-projects',
          mode: 'rw',
        },
        {
          source: '${RIKUNE_DATA_ROOT:-D:/Docker/rikune}/ghidra-logs',
          target: '/ghidra-logs',
          mode: 'rw',
        },
      ],
    },
    {
      ...
      versionFlag: '-version',
      required: true,
      description: 'Java 17+ runtime (Temurin recommended)',
