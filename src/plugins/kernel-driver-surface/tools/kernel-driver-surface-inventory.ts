...
const KernelDriverSurfaceInventorySchema = z.object({
  ...
  windows_surface: z.record(z.string(), z.any()),
  linux_surface: z.record(z.string(), z.any()),
  ioctl_candidates: z.array(z.record(z.string(), z.any())),
  device_interfaces: z.array(z.record(z.string(), z.any())),
  dispatch_hints: z.array(z.record(z.string(), z.any())),
  module_metadata: z.array(z.record(z.string(), z.any())),
  risky_primitives: z.array(z.record(z.string(), z.any())),
