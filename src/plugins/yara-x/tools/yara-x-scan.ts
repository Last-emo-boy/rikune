...
export const yaraXScanOutputSchema = z.object({
  ...
  data: z
    .object({
      ...
      backend_semantics: z.record(z.any()).optional(),
      ruleset_provenance: z.record(z.any()).optional(),
      validation_semantics: z.record(z.any()).optional(),
      corroboration_plan: z.record(z.any()).optional(),
