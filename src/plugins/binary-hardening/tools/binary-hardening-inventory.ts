...
const BinaryHardeningInventorySchema = z.object({
  ...
  mitigation_summary: z.record(z.any()),
  mitigations: z.array(z.record(z.any())),
  hardware_features: z.array(z.record(z.any())),
  section_risks: z.array(z.record(z.any())),
  risk_flags: z.array(z.record(z.any())),
  posture: z.record(z.any()),
