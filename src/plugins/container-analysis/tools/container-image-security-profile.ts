...
const ContainerImageSecurityProfileDataSchema = z.object({
  ...
  selected_image: z.record(z.string(), z.any()),
  config_digest: z.string().optional(),
  platform: z.record(z.string(), z.any()),
  runtime_config: z.record(z.string(), z.any()),
  layer_summary: z.record(z.string(), z.any()),
  history_summary: z.record(z.string(), z.any()),
