...
$nativeDiagnosticCases = @(
    ...
    @{ Snapshot = "snapshot-secret-acl-init-clr-load"; Category = "acl-snapshot-match-child-other"; ExitCode = 94; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-clr-load-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-clr-start"; Category = "acl-snapshot-match-child-other"; ExitCode = 95; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-clr-start-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-appdomain"; Category = "acl-snapshot-match-child-other"; ExitCode = 96; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-appdomain-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-managed-entry-load"; Category = "acl-snapshot-match-child-other"; ExitCode = 97; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-managed-entry-load-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-managed-entry-dispatch"; Category = "acl-snapshot-match-child-other"; ExitCode = 101; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-managed-entry-dispatch-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-managed-entry-invoke"; Category = "acl-snapshot-match-child-other"; ExitCode = 102; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-managed-entry-invoke-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-managed-exception"; Category = "acl-snapshot-match-child-other"; ExitCode = 103; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-managed-exception-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-iss-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 105; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-initial-session-state-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-psetwlog-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 107; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-psetwlog-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-etw-activity-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 108; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-etw-activity-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-consolehost-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 111; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-consolehost-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-task-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 112; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-task-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-sma-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 113; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-sma-namespace-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-microsoft-powershell-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 114; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-microsoft-powershell-namespace-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-system-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 115; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-system-namespace-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-utils-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 117; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-utils-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-psversioninfo-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 118; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-psversioninfo-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-pssnapin-reader-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 119; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-pssnapin-reader-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-bounded-ascii-type-init"; Category = "acl-snapshot-match-child-other"; ExitCode = 109; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-bounded-ascii-type-init-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-sma-exact-token-near-miss"; Category = "unclassified"; ExitCode = 120; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false },
    @{ Snapshot = "snapshot-secret-acl-init-namespace-token-near-miss"; Category = "unclassified"; ExitCode = 116; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false },
    @{ Snapshot = "snapshot-secret-acl-init-bounded-token-near-miss"; Category = "unclassified"; ExitCode = 110; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false },
    @{ Snapshot = "snapshot-secret-acl-init-iss-token-near-miss"; Category = "unclassified"; ExitCode = 106; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false },
    @{ Snapshot = "snapshot-secret-acl-init-consolehost"; Category = "acl-snapshot-match-child-other"; ExitCode = 98; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-consolehost-startup-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-pre-unlink-consolehost"; Category = "acl-pre-unlink-child-other"; ExitCode = 100; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-consolehost-startup-shape" },
    ...
    @{ Snapshot = "snapshot-secret-acl-init-refined-mixed-case"; Category = "acl-snapshot-match-child-other"; ExitCode = 99; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false; ChildStatus = "0xFFFF0000"; ChildStderr = "legacy-en-consolehost-startup-shape" },
    @{ Snapshot = "snapshot-secret-acl-init-retired-grouped-token"; Category = "unclassified"; ExitCode = 104; Phase = "verifier-diagnostic"; UseRemoveWrapper = $false },
...
process.stdin.on('end', () => {
  ...
  const cases = {
    ...
    'snapshot-secret-acl-init-clr-load': [94, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-clr-load-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-clr-start': [95, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-clr-start-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-appdomain': [96, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-appdomain-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-managed-entry-load': [97, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-managed-entry-load-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-managed-entry-dispatch': [101, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-managed-entry-dispatch-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-managed-entry-invoke': [102, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-managed-entry-invoke-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-managed-exception': [103, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-managed-exception-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-iss-type-init': [105, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-initial-session-state-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-psetwlog-type-init': [107, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-psetwlog-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-etw-activity-type-init': [108, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-etw-activity-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-consolehost-type-init': [111, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-consolehost-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-task-type-init': [112, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-task-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-sma-type-init': [113, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-sma-namespace-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-microsoft-powershell-type-init': [114, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-microsoft-powershell-namespace-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-system-type-init': [115, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-system-namespace-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-utils-type-init': [117, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-utils-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-psversioninfo-type-init': [118, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-psversioninfo-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-pssnapin-reader-type-init': [119, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-pssnapin-reader-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-bounded-ascii-type-init': [109, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-bounded-ascii-type-init-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-sma-exact-token-near-miss': [120, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-utils-type-init)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-namespace-token-near-miss': [116, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-sma-namespace-type-init)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-bounded-token-near-miss': [110, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-bounded-ascii-type-init)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-iss-token-near-miss': [106, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-initial-session-state-type-init)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-consolehost': [98, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-consolehost-startup-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-pre-unlink-consolehost': [100, `node.exe : Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-pre-unlink-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-consolehost-startup-shape)   \nError: ignored '${mode}-child-secret-marker'\n`],
    ...
    'snapshot-secret-acl-init-refined-mixed-case': [99, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xffff0000; child-stderr=LeGaCy-En-CoNsOlEhOsT-StArTuP-ShApE)\nError: ignored '${mode}-child-secret-marker'\n`],
    'snapshot-secret-acl-init-retired-grouped-token': [104, `Error: RIKUNE_PRIVATE_ENV_FAILURE=acl-snapshot-match-child-other: Unable to verify Windows ACL (child-status=0xFFFF0000; child-stderr=legacy-en-managed-entry-shape)\nError: ignored '${mode}-child-secret-marker'\n`],
