...
const RustBinaryInventorySchema = z.object({
  ...
  rustc_candidates: z.array(z.record(z.string(), z.any())),
  cargo_markers: z.array(z.record(z.string(), z.any())),
  crate_candidates: z.array(z.record(z.string(), z.any())),
  target_triples: z.array(z.record(z.string(), z.any())),
  symbol_mangling: z.record(z.string(), z.any()),
  runtime_markers: z.array(z.record(z.string(), z.any())),
  panic_profile: z.record(z.string(), z.any()),
  ecosystem_markers: z.array(z.record(z.string(), z.any())),
  provenance_markers: z.array(z.record(z.string(), z.any())),
