...
const CompilerCodegenFingerprintSchema = z.object({
  ...
  compiler_candidates: z.array(z.record(z.string(), z.any())),
  linker_candidates: z.array(z.record(z.string(), z.any())),
  language_runtime_hints: z.array(z.record(z.string(), z.any())),
  optimization_hints: z.array(z.record(z.string(), z.any())),
  codegen_features: z.array(z.record(z.string(), z.any())),
  provenance_markers: z.array(z.record(z.string(), z.any())),
  section_layout: z.record(z.string(), z.any()),
