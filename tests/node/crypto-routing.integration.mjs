...
const { createCryptoIdentifyHandler } = await import('../../dist/plugins/static-triage/tools/crypto-identify.js')
const { createBreakpointSmartHandler } = await import('../../dist/plugins/static-triage/tools/breakpoint-smart.js')
